...
Function: parse
 ...
 General:
 * Is the function correct? Probably not...
 * Is the function documented correctly (i.e. contract and purpose statement)? Y

 Feature: literals
 * Is there an example of parsing a number expression properly? L221
 * Is there a test case for a literal that is not a number? L222

 Feature: binary operators
 * Is there an example of parsing a + expression properly? L225
 * Is there an example of parsing a - expression properly? L226
 * Is there an example of parsing a * expression properly? L227
 * Is there an example of parsing a / expression properly? L228
 * Is there a test case for: too few pieces? L229
 * Is there a test case for: too many pieces? L230

 Feature: id
 * Is there an example of parsing a id expression properly? L222
 * Is there a test case for: not an id (+)? L233
 * Is there a test case for: not an id (-)? L234
 * Is there a test case for: not an id (*)? L235
 * Is there a test case for: not an id (/)? L236
 * Is there a test case for: not an id (with)? L237
 * Is there a test case for: not an id (if0)? L238
 * Is there a test case for: not an id (fun)? L239

 Feature: if0
 * Is there an example of parsing a if0 expression properly? L242
 * Is there a test case for: too few pieces? L243
 * Is there a test case for: too many pieces? L244
