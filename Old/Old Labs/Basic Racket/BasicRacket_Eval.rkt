...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname BasicRacket_Eval) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
